...
PRODUCT CODES (core):
- PA  = PremierAdvantage
- PC  = PremierChoice (similar to PA, only in select states)
- HA  = HealthAccess
- SA  = SecureAdvantage
- SAGI = SAGI (rare policy type, treat like SA)
- Suppy / Supplemental = Supplemental
- Wrap / ACA Wrap / 🌯 = Wrap (ACA policy bundled with products)
- UHC / UHC x1 / UHC x2 / UHC x3 etc. = Wrap (UnitedHealthCare wrapped policy — the number indicates how many wrapped policies, include it e.g. "Wrap x3")

DEFAULT RULE: If a dollar amount is present but NO core product code is visible (no PA/PC/HA/SA/SAGI/Suppy/Wrap/UHC), assume the core product is Supplemental.
...
- OTF = On The Fly
- FNB = First New Business (agent opened their portal for the first time)
...
- "UHC x1 $98 💎 Dental/Vision" → premium:98, products:"Wrap x1 + Dental + Vision", association:"Diamond", deal_tags:""
- "UHC x3 $310 PA Diamond" → premium:310, products:"Wrap x3 + PA", association:"Diamond", deal_tags:""
- "$426 PC 💎 🦷 👀 OTF" → premium:426, products:"PC + Dental + Vision", association:"Diamond", deal_tags:"OTF"
